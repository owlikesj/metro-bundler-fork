...
var _require =
  ...
  require('./util');
const generateAssetTransformResult = _require.generateAssetTransformResult,
...
var _require2 =
  ...
  require('path');
const pathSeparator = _require2.sep,
  joinPath = _require2.join,
  pathDirname = _require2.dirname,
...
var _require3 =
  ...
  require('../Logger');
const createActionStartEntry = _require3.createActionStartEntry,
  createActionEndEntry = _require3.createActionEndEntry,
  log = _require3.log;
const
...
class Bundler {
  ...
  bundle(options) {
    ...
    then(
      resolver => resolver.getModuleSystemDependencies({
        dev,
        unbundle
      })).
  ...
  _bundle(_ref) {
    let assetPlugins = _ref.assetPlugins,
      bundle = _ref.bundle,
      dev = _ref.dev,
      entryFile = _ref.entryFile,
      entryModuleOnly = _ref.entryModuleOnly,
      generateSourceMaps = _ref.generateSourceMaps,
      hot = _ref.hot,
      isolateModuleIDs = _ref.isolateModuleIDs,
      minify = _ref.minify;
    var _ref$moduleSystemDeps = _ref.moduleSystemDeps;
    let moduleSystemDeps = _ref$moduleSystemDeps === undefined ? [] : _ref$moduleSystemDeps,
      onProgress = _ref.onProgress,
      platform = _ref.platform,
      resolutionResponse = _ref.resolutionResponse,
      runBeforeMainModule = _ref.runBeforeMainModule,
      runModule = _ref.runModule,
      unbundle = _ref.unbundle;
    ...
    const finalizeBundle = (_ref2) => {
      let
        ...
        modulesByName = _ref2.modulesByName;
      return (
        ...
        this._resolverPromise.then(resolver =>
          Promise.all(
            transformedModules.map((_ref3) => {
              let module = _ref3.module,
                transformed = _ref3.transformed;
              return (
  ...
  _buildBundle(_ref4) {
    let entryFile = _ref4.entryFile,
      dev = _ref4.dev,
      minify = _ref4.minify,
      platform = _ref4.platform,
      bundle = _ref4.bundle,
      hot = _ref4.hot,
      unbundle = _ref4.unbundle,
      resolutionResponse = _ref4.resolutionResponse,
      isolateModuleIDs = _ref4.isolateModuleIDs,
      generateSourceMaps = _ref4.generateSourceMaps,
      assetPlugins = _ref4.assetPlugins;
    var _ref4$onResolutionRes = _ref4.onResolutionResponse;
    let onResolutionResponse = _ref4$onResolutionRes === undefined ? emptyFunction : _ref4$onResolutionRes;
    var _ref4$onModuleTransfo = _ref4.onModuleTransformed;
    let onModuleTransformed = _ref4$onModuleTransfo === undefined ? emptyFunction : _ref4$onModuleTransfo;
    var _ref4$finalizeBundle = _ref4.finalizeBundle;
    let finalizeBundle = _ref4$finalizeBundle === undefined ? emptyFunction : _ref4$finalizeBundle;
    var _ref4$onProgress = _ref4.onProgress;
    let onProgress = _ref4$onProgress === undefined ? emptyFunction : _ref4$onProgress;
  ...
  getShallowDependencies(_ref7) {
    let entryFile = _ref7.entryFile,
      rootEntryFile = _ref7.rootEntryFile,
      platform = _ref7.platform;
    var _ref7$dev = _ref7.dev;
    let dev = _ref7$dev === undefined ? true : _ref7$dev;
    var _ref7$minify = _ref7.minify;
    let minify = _ref7$minify === undefined ? !dev : _ref7$minify;
    var _ref7$hot = _ref7.hot;
    let hot = _ref7$hot === undefined ? false : _ref7$hot;
    var _ref7$generateSourceM = _ref7.generateSourceMaps;
    let generateSourceMaps = _ref7$generateSourceM === undefined ? false : _ref7$generateSourceM;
  ...
  getDependencies(_ref8) {
    var _this = this;
    let entryFile = _ref8.entryFile,
      platform = _ref8.platform;
    var _ref8$dev = _ref8.dev;
    let dev = _ref8$dev === undefined ? true : _ref8$dev;
    var _ref8$minify = _ref8.minify;
    let minify = _ref8$minify === undefined ? !dev : _ref8$minify;
    var _ref8$hot = _ref8.hot;
    let hot = _ref8$hot === undefined ? false : _ref8$hot;
    var _ref8$recursive = _ref8.recursive;
    let recursive = _ref8$recursive === undefined ? true : _ref8$recursive;
    var _ref8$generateSourceM = _ref8.generateSourceMaps;
    let generateSourceMaps = _ref8$generateSourceM === undefined ? false : _ref8$generateSourceM;
    var _ref8$isolateModuleID = _ref8.isolateModuleIDs;
    let isolateModuleIDs = _ref8$isolateModuleID === undefined ? false : _ref8$isolateModuleID,
      rootEntryFile = _ref8.rootEntryFile,
  ...
  getOrderedDependencyPaths(_ref9) {
    let entryFile = _ref9.entryFile,
      dev = _ref9.dev,
      platform = _ref9.platform,
      minify = _ref9.minify,
      generateSourceMaps = _ref9.generateSourceMaps;
  ...
  _toModuleTransport(_ref12) {
    let module = _ref12.module,
      bundle = _ref12.bundle,
      entryFilePath = _ref12.entryFilePath,
      options = _ref12.options,
      getModuleId = _ref12.getModuleId,
      dependencyPairs = _ref12.dependencyPairs,
      assetPlugins = _ref12.assetPlugins;
    let moduleTransport;
    ...
    then((_ref13) => {
      ...
      let name = _ref14[0];
      var _ref14$ = _ref14[1];
      let code = _ref14$.code,
        dependencies = _ref14$.dependencies,
        dependencyOffsets = _ref14$.dependencyOffsets,
        map = _ref14$.map,
  ...
  _generateAssetObjAndCode(
    ...
    let moduleName = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
    ...
    then(asset => {
      ...
      const code = _generateAssetTransfo.code,
        dependencies = _generateAssetTransfo.dependencies,
        dependencyOffsets = _generateAssetTransfo.dependencyOffsets;
      return {
        asset,
        code,
        meta: {
  ...
  _applyAssetPlugins(
    ...
    var _assetPlugins = _toArray(
      ...
      assetPlugins);
    const currentAssetPlugin = _assetPlugins[0],
      remainingAssetPlugins = _assetPlugins.slice(1);
    /* $FlowFixMe: dynamic requires prevent static typing :'(  */
  ...
  _generateAssetModule(
    ...
    module,
    moduleId) {
    let assetPlugins = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : [];
    let platform = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : null;
    let array = bundle._mainModuleId.split('/');
    let moduleName = ''
    if (array.length > 1) {
      moduleName = array[1].replace('.js', '');
    }

    return Promise.all([
      module.getName(),
      this._generateAssetObjAndCode(module, assetPlugins, platform, moduleName)
    ]).
    then((_ref15) => {
      var _ref16 = _slicedToArray(_ref15, 2);
      let name = _ref16[0];
      var _ref16$ = _ref16[1];
      let asset = _ref16$.asset,
        code = _ref16$.code,
        meta = _ref16$.meta;
  ...
  getTransformOptions(
    ...
    return _asyncToGenerator(function* () {
      ...
      const transform = _extraOptions$transfo === undefined ? {} : _extraOptions$transfo;
...
function createModuleIdFactory() {
  ...
  return (_ref17) => {
    ...
    return _ref17.localPath;
  };
}

function getMainModule(_ref18) {
  let dependencies = _ref18.dependencies;
  var _ref18$numPrependedDe = _ref18.numPrependedDependencies;
  let numPrependedDependencies = _ref18$numPrependedDe === undefined ? 0 : _ref18$numPrependedDe;
